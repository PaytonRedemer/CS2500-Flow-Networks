...
If a virtual vertex is generated by the program, it is listed either in the input section or between the input and output sections as "A virtual vertext <name> and two arcs <start,end,capacity>, <start,end,capacity> were generated to replace arc <start,end,capacity>."
...
a,b,12
a,c,9
A virtual vertext replace1 and two arcs <c,replace1,6>, <replace1,a,6> were generated to replace arc <c,a,6>.
b,c,9
A virtual vertext replace2 and two arcs <c,replace2,19>, <replace2,b,19> were generated to replace arc <c,b,19>.
d,g,45
